...
This project is indexed by GitNexus as **noob-components-v2** (1080 symbols, 1972 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
