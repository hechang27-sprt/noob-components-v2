...
This project is indexed by GitNexus as **noob-components-v2** (1179 symbols, 2179 relationships, 49 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
